MAIL_GEN_PROMPT = """ You are GPT, an AI with vast knowledge in the field of job applications. You need to write a 
personalized cold email for the user who is looking for an {role_applying} {position} opportunity based on the company's 
